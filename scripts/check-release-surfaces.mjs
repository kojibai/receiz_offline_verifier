...
const upstreamCommittedBase = "924e687d6a031c9bb4ca358fc7f92ea3de1066f5";
const standalonePredecessor = "b9ef7e2a0dcb8701fcdfbd49c17c2826fbf6a70e";
const historicalStandaloneTagCommit = "c184f2799680264b9dfba32253e7338a546d89db";
const expectedOfflineVerifierDigest = "da389f3df9ffe181ce019975d45263da76fbf89f53edf08eafe6682ec9380d22";
const expectedOfflineStudioDigest = "c0fbcff2bfbad8d051ce034798dbb8c8737fdf634351be2329134131c24aa037";
const sourceReleaseBookManifest = "92b62cc9f75d8c41b5f2337937238f3bf88e43bf0e6480b1dae3bdfe44b7fb81";
...
const currentReleasePointers = [
  ...
  [`docs/releases/${releaseVersion}-product-truth.md`, "V124.1.0 composes source-carried proof"],
  ...
  [`docs/releases/${releaseVersion}-checklist.md`, "Exact source-family, progressive-range, native Record/Seal"],
  ...
  [`docs/releases/${releaseVersion}-regression-lessons.md`, "Source-carried material, raw-decoder, progressive-range"],
  ...
  [`docs/releases/${releaseVersion}-commit-history.md`, "The standalone implementation sequence after annotated tag `v124.0.3` contains four commits"],
  ...
  [`docs/releases/${releaseVersion}-conformance.md`, "Conformance requires exact agreement"],
  ...
  [`docs/releases/${releaseVersion}-full-arc.md`, "V124.1.0 completes the convergence"],
  [`docs/releases/${releaseVersion}-governance.md`, "additive minor release"],
  [`docs/releases/${releaseVersion}-migration.md`, "No artifact, registry, database, identity, conversation, ownership, or settlement migration is required"],
  [`docs/releases/${releaseVersion}-security.md`, "Never place clear conversation messages"],
  [`docs/releases/${releaseVersion}-v125-horizon.md`, "V124.1.0 is complete inside the V124 compatibility range"],
...
const errors = [];
if (bareVersion !== "124.1.0") errors.push(`package.json version is ${bareVersion}, expected 124.1.0`);
...
if (sha256File("apps/offline-verifier.html") !== expectedOfflineVerifierDigest) {
  errors.push("Canonical standalone verifier bytes do not match the v124.1.0 source digest");
}
if (sha256File("apps/offline-record-seal.html") !== expectedOfflineStudioDigest) {
  errors.push("Offline Studio bytes do not match the v124.1.0 source digest");
}
...
if (historicalStandaloneTagCommit === standalonePredecessor) {
  errors.push("Historical v124.0.3 tag and v124.1.0 standalone predecessor must remain distinct");
}
