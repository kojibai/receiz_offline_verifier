...
Current release: `v76.0.0`

## What changed in v76.0.0
- Current release/docs surfaces are aligned to `v76.0.0`.
- Published the canonical `v76.0.0` world agent revenue loop, Public Proof, and Market Twin release note at [docs/releases/v76.0.0.md](docs/releases/v76.0.0.md).
- Published the release-scoped product-truth freeze at [docs/releases/v76.0.0-product-truth.md](docs/releases/v76.0.0-product-truth.md).
- Published the release checklist at [docs/releases/v76.0.0-checklist.md](docs/releases/v76.0.0-checklist.md).
- Published the release process at [docs/releases/v76.0.0-process.md](docs/releases/v76.0.0-process.md).
- `v76.0.0` preserves `v70.0.0`, `v74.0.0`, and `v75.0.0` baseline law while adding protected concierge response continuity, public-safe agent trace UX, world revenue mission/value loops, Sales Brain/autopilot, campaign follow-up email-default delivery, and mandate-safe Market Twin authority persistence.
- The `v64.0.0` value-loop invariants remain in force.
- No new database migration is required by this documentation cut.
- Current shipped verifier, studio, and settlement entrypoints now display `v76.0.0`.
- Root package metadata now resolves cleanly to `v76.0.0`.
...
The repo-local conformance hub at [docs/conformance/README.md](docs/conformance/README.md) tracks the latest vendored conformance snapshot in this repository. It includes live badge surfaces, current imported results, and suite-by-suite requirement coverage docs for the currently imported suites; the broader `v76.0.0` release is documented in the release note and can be vendored here on the next snapshot refresh.

## Release train highlights (v14 -> v76)
...
## Repository layout
- [docs/README.md](docs/README.md): documentation map for `v76.0.0`.
- [docs/releases/v76.0.0.md](docs/releases/v76.0.0.md): canonical World Agent revenue, Public Proof, and Market Twin release note for `v76.0.0`.
...
- [docs/releases/v70.0.0-invariant-register.md](docs/releases/v70.0.0-invariant-register.md): public alpha invariant register carried forward by `v76.0.0`.
- [docs/literal-product-law.md](docs/literal-product-law.md): literal product law carried forward for `v76.0.0`.
