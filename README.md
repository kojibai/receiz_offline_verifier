...
Current release: `v47.7.0`

## What changed in v47
- Current release/docs surfaces are aligned to `v47.7.0`.
- Published the canonical `v47.7.0` release note at [docs/releases/v47.7.0.md](docs/releases/v47.7.0.md).
- Published the release-scoped product-truth freeze at [docs/releases/v47.7.0-product-truth.md](docs/releases/v47.7.0-product-truth.md).
- `v47.7.0` is the durable contacts production release; verifier semantics remain unchanged from `v47.0.0`.
- Contacts now persist as a migration-backed CRM with historical participant/original-collector backfill, server-truth notes and timelines, and deduped import/export flows across CSV, JSON, vCard, phone contacts, and local cache.
...
## Repository layout
- [docs/README.md](docs/README.md): documentation map for `v47.7.0`.
...
- [docs/releases/v47.7.0.md](docs/releases/v47.7.0.md): canonical `v47.7.0` release note.
- [docs/releases/v47.7.0-product-truth.md](docs/releases/v47.7.0-product-truth.md): `v47.7.0` product-truth freeze document.
