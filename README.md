...
Current release: `v104.0.0`

## What changed in v104.0.0
- Current release/docs surfaces are aligned to `v104.0.0`.
- Published the Application Contract Compiler release at [docs/releases/v104.0.0.md](docs/releases/v104.0.0.md).
- Published the release-scoped product-truth freeze at [docs/releases/v104.0.0-product-truth.md](docs/releases/v104.0.0-product-truth.md).
- Published the release checklist at [docs/releases/v104.0.0-checklist.md](docs/releases/v104.0.0-checklist.md).
- Published the release process at [docs/releases/v104.0.0-process.md](docs/releases/v104.0.0-process.md).
- Published the regression lessons lock at [docs/releases/v104.0.0-regression-lessons.md](docs/releases/v104.0.0-regression-lessons.md).
- Published the performance findings at [docs/releases/v104.0.0-performance-findings.md](docs/releases/v104.0.0-performance-findings.md).
- Published the invariant register at [docs/releases/v104.0.0-invariant-register.md](docs/releases/v104.0.0-invariant-register.md).
- Published the commit-history boundary at [docs/releases/v104.0.0-commit-history.md](docs/releases/v104.0.0-commit-history.md).
- A typed application contract compiles deterministically through the SDK into scopes, environments, framework wiring, findings, safe previews, conformance, and upgrade guidance.
- CLI and MCP remain thin interfaces; inspection and application conformance are not proof verification.
- Automatic writes require the exact reviewed digest and remain confined to the explicit repository root.
- Next.js generation adds small modules without browser secrets or database proof authority.
- SDK, MCP, and AI-skills packages align exactly at 104.0.0 with no packed `workspace:` dependencies.
...
- Broader platform target environments require SDK compiler/CLI, MCP tools/resources, AI-skill distribution, exact package alignment, packed artifact inspection, empty-project installation, historical proof compatibility, release-freeze, governance, package publication, and production smoke gates named in [docs/releases/v104.0.0-checklist.md](docs/releases/v104.0.0-checklist.md).
- Current shipped verifier, Sports card verifier, studio, and settlement entrypoints now display `v104.0.0`.
- Root package metadata now resolves cleanly to `104.0.0`.
- The static service-worker surface carries runtime version `104.0.0`.
...
The repo-local conformance hub at [docs/conformance/README.md](docs/conformance/README.md) tracks the latest vendored conformance snapshot in this repository. It includes live badge surfaces, current imported results, and suite-by-suite requirement coverage docs for the currently imported suites; the broader `v104.0.0` release is documented in the release note and can be vendored here on the next snapshot refresh.
...
- `v104.0.0`: Application Contract Compiler adds deterministic SDK-owned app integration compilation, thin CLI/MCP interfaces, digest-confirmed root-confined changes, safe Next.js wiring, and exact externally installable coordinated packages.
...
## Repository layout
- [docs/README.md](docs/README.md): documentation map for `v104.0.0`.
- [docs/releases/v104.0.0.md](docs/releases/v104.0.0.md): canonical Application Contract Compiler release for `v104.0.0`.
- [docs/releases/v104.0.0-product-truth.md](docs/releases/v104.0.0-product-truth.md): `v104.0.0` product-truth freeze document.
- [docs/releases/v104.0.0-checklist.md](docs/releases/v104.0.0-checklist.md): release-prep checklist and additional gates for `v104.0.0`.
- [docs/releases/v104.0.0-process.md](docs/releases/v104.0.0-process.md): release-prep process for `v104.0.0`.
- [docs/releases/v104.0.0-regression-lessons.md](docs/releases/v104.0.0-regression-lessons.md): required regression lessons lock for `v104.0.0`.
- [docs/releases/v104.0.0-performance-findings.md](docs/releases/v104.0.0-performance-findings.md): compiler determinism, root confinement, safe generation, and external-install boundaries for `v104.0.0`.
- [docs/releases/v104.0.0-invariant-register.md](docs/releases/v104.0.0-invariant-register.md): locked invariant register for `v104.0.0`.
- [docs/releases/v104.0.0-commit-history.md](docs/releases/v104.0.0-commit-history.md): required commit-history boundary for `v104.0.0`.
- [docs/receiz-reasoning-kernel.md](docs/receiz-reasoning-kernel.md): primitive-first reasoning kernel carried forward for `v104.0.0`.
...
- [docs/releases/v70.0.0-invariant-register.md](docs/releases/v70.0.0-invariant-register.md): public alpha invariant register carried forward by `v104.0.0`.
- [docs/literal-product-law.md](docs/literal-product-law.md): literal product law carried forward for `v104.0.0`.
...
- [docs/truthful-speed-invariants.md](docs/truthful-speed-invariants.md): truthful speed and first-paint invariants carried forward for `v104.0.0`.
- [docs/scale-reasoning-invariants.md](docs/scale-reasoning-invariants.md): scale, deterministic chart, closeout, and primitive-preservation law carried forward for `v104.0.0`.
