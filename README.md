...
Current release: `v47.6.0`

## What changed in v47
- Current release/docs surfaces are aligned to `v47.6.0`.
- Published the canonical `v47.6.0` release note at [docs/releases/v47.6.0.md](docs/releases/v47.6.0.md).
- Published the release-scoped product-truth freeze at [docs/releases/v47.6.0-product-truth.md](docs/releases/v47.6.0-product-truth.md).
- `v47.6.0` is the world command-center and contacts-operations release; verifier semantics remain unchanged from `v47.0.0`.
- World now adds a map-first atlas shell, concierge twin-run quarterbacking, a standalone contacts operating surface, and more truthful outreach / checkout completion behavior without weakening trust or payment primitives.
...
## Repository layout
- [docs/README.md](docs/README.md): documentation map for `v47.6.0`.
...
- [docs/releases/v47.6.0.md](docs/releases/v47.6.0.md): canonical `v47.6.0` release note.
- [docs/releases/v47.6.0-product-truth.md](docs/releases/v47.6.0-product-truth.md): `v47.6.0` product-truth freeze document.
