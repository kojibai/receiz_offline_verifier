...
Status: Canonical from `v64.0.0`; carried forward for `v124.0.1`
Release date: April 21, 2026

## Purpose

This document defines the release-stable value-loop invariants for Receiz. It is the canonical cross-surface reference for wallet, market, certificate, note, and wire-transfer behavior introduced in `v64.0.0` and carried forward by `v124.0.1`.
