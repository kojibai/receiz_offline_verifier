...
Use these strings and framing rules for v22 verifier UX and release communications.
...
- "Anchor data present"
- "Deterministic Groth16 proof artifacts" (UI label; v22 policy enforces real `g16:` proof validation)
...
- Do not describe missing/unavailable signature states as warnings in v22 materials.
