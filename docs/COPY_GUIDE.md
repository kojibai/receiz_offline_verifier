...
Use these strings and framing rules for `v27` verifier UX and release communications.
...
- "Anchor data present"
- "Deterministic Groth16 proof artifacts" (UI label; `v27` policy enforces real `g16:` proof validation)
...
## Warning copy
- No trusted-signature warning copy is used in `v27`; unavailable `signatureV4` is a hard failure.
