...
Use these strings and framing rules for `v29` verifier UX and release communications.
...
- "Anchor data present"
- "Deterministic Groth16 proof artifacts" (UI label; `v29` policy enforces real `g16:` proof validation)
...
## Warning copy
- No trusted-signature warning copy is used in `v29`; unavailable `signatureV4` is a hard failure.
