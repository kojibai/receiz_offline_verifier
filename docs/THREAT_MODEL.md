...
6. Groth16 spoofing: fake deterministic/real proof artifacts.
7. UI deception: presenting verified state without required integrity proofs.
...
- Signature v3 payload validation (shape + payload hash + Ed25519 verification when applicable).
