...
`v86.0.0` carries the artifact-system law forward: Receiz is a proof-native artifact system. Files, identities, vault objects, ownership states, settlement states, public witness surfaces, and verification routes carry product truth.
