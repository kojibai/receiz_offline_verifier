...
This directory contains JSON Schemas for verifier-visible payloads used in `v40`.
...
- In `v40`, trusted verification requires valid `signatureV4`, effective anchor context, and real `g16:` Groth16 proof artifacts.
