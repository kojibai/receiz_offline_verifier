...
This directory is the public documentation set for Receiz `v53.0.0`.

## Start Here

- [releases/v53.0.0.md](releases/v53.0.0.md): canonical public release note for `v53.0.0`.
- [releases/v53.0.0-product-truth.md](releases/v53.0.0-product-truth.md): release-scoped product-truth freeze for `v53.0.0`.
