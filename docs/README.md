...
This directory is the public documentation set for Receiz `v48.0.0`.

## Start Here

- [releases/v48.0.0.md](releases/v48.0.0.md): canonical public release note for `v48.0.0`.
- [releases/v48.0.0-product-truth.md](releases/v48.0.0-product-truth.md): release-scoped product-truth freeze for `v48.0.0`.
