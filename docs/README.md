...
This directory is the public documentation set for Receiz `v56.0.0`.

## Start Here

- [releases/v56.0.0.md](releases/v56.0.0.md): canonical public release note for `v56.0.0`.
- [releases/v56.0.0-product-truth.md](releases/v56.0.0-product-truth.md): release-scoped product-truth freeze for `v56.0.0`.
- [releases/v56.0.0-checklist.md](releases/v56.0.0-checklist.md): release-prep checklist and additional gates for `v56.0.0`.
