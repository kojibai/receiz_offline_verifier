...
This directory is the public documentation set for Receiz `v50.0.0`.

## Start Here

- [releases/v50.0.0.md](releases/v50.0.0.md): canonical public release note for `v50.0.0`.
- [releases/v50.0.0-product-truth.md](releases/v50.0.0-product-truth.md): release-scoped product-truth freeze for `v50.0.0`.
