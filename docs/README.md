...
This directory is the public documentation set for Receiz `v47.5.0`.

## Start Here

- [releases/v47.5.0.md](releases/v47.5.0.md): canonical public release note for `v47.5.0`.
- [releases/v47.5.0-product-truth.md](releases/v47.5.0-product-truth.md): release-scoped product-truth freeze for `v47.5.0`.
