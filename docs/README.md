...
This directory is the public documentation set for Receiz `v78.0.0`.

## Start Here

- [releases/v78.0.0.md](releases/v78.0.0.md): canonical Signal Card World, Vault Export, Battle Arena, Exchange, and PWA Continuity release note for `v78.0.0`.
...
- [releases/v70.0.0-invariant-register.md](releases/v70.0.0-invariant-register.md): invariant register for the public alpha release boundary carried forward by `v78.0.0`.
