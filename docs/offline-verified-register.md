...
The register stores compact verified blocks. A block may represent identity bootstrap, artifact proof, deterministic ledger evidence, route snapshot truth, twin mind projection, wallet graph state, market position truth, or account continuity evidence.
...
- A missing or anonymous network session must not erase a valid local identity block.
