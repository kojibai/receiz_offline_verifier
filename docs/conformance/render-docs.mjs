...
This repo-local hub vendors the currently imported suites from [receiz.com/conformance](${index.sourcePage}) into durable docs that are easy to reference in code review, audits, and product docs.
...
- [index.json](index.json): machine-readable summary for the currently imported suites, their live endpoints, and the imported snapshot metadata.
